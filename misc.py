...
r7 = Weapon("Used Needle", "Don't poke yourself though", 0, 6)
...
s0 = Shoes("Jordans", "Slightly creased", 30, 5)
s1 = Clothes("Shirt", "A striped long-sleeve shirt", 20, 18)
s2 = Disguise("Cloak", "A black cloak", 25)
s3 = Shoes("Running Shoes", "A pair of new running shoes", 50, 10)
s4 = Clothes("Jersey", "A basketball jersey", 15, 15)
s5 = Disguise("Ski Mask", "A black ski mask", 10)
s6 = Disguise("Glasses", "Very convincing glasses", 15)
s7 = Disguise("Braces", "Very convincing braces", 25)
s7 = Weapon("Kitchen Knife", "Brand new stainless steel", 10, 7)
s8 = Weapon("Nerf Gun", "Enhanced with thumbtacks", 30, 9)
s9 = Weapon("Slingshot", "David vs. Goliath cosplay", 15, 6)
s10 = Weapon("Nunchucks", "Don't hit yourself", 15, 6)
s11 = Food("Jar of Worms", "Contains a lot of protein, healthy!", 10, 25)
s12 = Food("Chicken", "Just a whole chicken", 20, 25)
s13 = Food("Strawberries", "One of the two fruits in this world", 7, 18)
s14 = Food("Persimmon", "One of the two fruits in this world", 5, 15)
s15 = Clothes("Overalls", "Jean overalls", 25, 20)
s16 = Clothes("Helmet", "Helmet with the mohawk spikes on top", 20, 18)
s17 = Clothes("Ball Guard", "Protect", 18, 16)
s18 = Clothes("Hoodie", "A black zip-up hoodie", 22, 21)
s19 = Shoes("Nikes", "White AF1", 40, 8)
s20 = Shoes("Adidas", "White", 40, 8)
s21 = Weapon("Axe", "A new axe", 25, 9)
s22 = Disguise("Jumpsuit", "Prisoner cosplay", 20)
...
enf0 = Enforcer("Trooper", random.choice(allRooms), random.sample(enforcer_items, random.randint(1,3)))
